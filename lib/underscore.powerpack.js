...
_.mixin({
  ...
  /**
   * _.capitalize
   * @description capitalize given string's first character
   * @param {string} str
   * @returns {string}
   */
  capitalize: function (str) {
    if (str == null || !_.isString(str)) throw new Error("{str} not set/not string");
  ...
  /**
   * _.trim (str)
   * @description trim string, polyfill for IE9-
   * @param {string} str
